...
if __name__ == '__main__':
    ...
    train_examples, val_examples = examples['train'].shard(num_shards=4, index=0), examples['validation']
    ...
    exit()
    # train_examples : <ShardDataset shapes: ((), ()), types: (tf.string, tf.string)>
    ...
    for epoch in range(EPOCHS):
        ...
        for (batch, (inp, tar)) in enumerate(train_dataset):
            ...
            if batch % 300 == 0:
                print('Epoch {} Batch {} Loss {:.12f} Accuracy {:.12f}'.format(epoch + 1, batch, train_loss.result(),
